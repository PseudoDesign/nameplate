...
from kiosk.views import outlook_login, get_token, home, outlook_logout, select_room, set_room, room_info, schedule_room
...
urlpatterns = [
    ...
    path(r'schedule_room', schedule_room, name='schedule_room'),
